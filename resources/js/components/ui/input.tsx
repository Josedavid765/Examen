...
export function Input({
    ...
    const inputClassName = cn(
        "h-10 w-full min-w-0 rounded-[inherit] px-3 leading-10 outline-none [transition:background-color_5000000s_ease-in-out_0s] placeholder:text-muted-foreground/72",
        size === "sm" && "h-9 px-2.5 leading-9",
        size === "lg" && "h-12 leading-12 sm:h-8.5 sm:leading-8.5",
        props.type === "search" &&
